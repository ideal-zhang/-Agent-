...
async def add_favorite(
    ...
    result = await favorite.add_favorites(db, user.id, data.news_id)
...
async def remove_favorite(
    ...
    res = await favorite.remove_favorites(db, user.id, news_id)
    if not res :
...
async def get_favorite_list(
    ...
    rows, total = await favorite.get_favorites(db, user.id, page, page_size)
    favorite_list = [{
        **news.__dict__,
